...
#Region "Constructores"
    ...
    Public Sub New(ByVal session As UserSession, ByVal cnn As IDbConnection, ByVal tran As IDbTransaction)
        MyBase.New("Production","Incidencias", session)
        Me.Connection = cnn
        Me.Transaction = tran
    End Sub
#End Region
...
#Region "Metodos de CatalogService"
    Public Overrides Sub GetDetail(ByVal idIncidencia As Integer, ByRef Incidencia As IncidenciaInfo, checkStatus As Boolean)
		MyBase.GetDetail(idIncidencia, Incidencia, checkStatus)
        With Incidencia
			.Nombre = CStr(Me.ItemInfo("Nombre"))
			.IdTipoIncidencia = CInt(Me.ItemInfo("IdTipoIncidencia"))
	...
	Public Overrides Function Update(ByVal Incidencia As IncidenciaInfo) As Integer
        With Me.SPUpdate.Parameters
			...
			.Add("@IdEmpresa", DbType.Int32).Value = Incidencia.IdEmpresa
	...
	Public Overrides Function Create() As IncidenciaInfo
		Return New IncidenciaInfo(Session)
	End Function
...
#Region "Metodos de CatalogFacade"
    ...
    ''' <remarks></remarks>
	Public Overrides Function Create(ByVal session As UserSession) As IncidenciaInfo
    ...
    ''' <remarks></remarks>
    Public Overrides Sub Delete(ByVal session As UserSession, ByVal idIncidencia As Integer)
		Dim IncidenciaSvc As New IncidenciaService(session)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overrides Function Exists(ByVal session As UserSession, ByVal idIncidencia As Integer) As Boolean
		Dim IncidenciaSvc As New IncidenciaService(session)
    ...
    ''' <remarks></remarks>
    Public Overrides Function GetDetail(ByVal session As UserSession, ByVal idIncidencia As Integer) As IncidenciaInfo
    ...
    ''' <returns>Paquete de información de tipo IncidenciaInfo</returns>
    ''' <remarks></remarks>
    Public Overrides Function GetDetail(ByVal session As UserSession, ByVal idIncidencia As Integer, checkStatus As Boolean) As IncidenciaInfo
   		Dim IncidenciaSvc As New IncidenciaService(session)
    ...
    ''' <remarks></remarks>
    Public Overloads Overrides Function GetDetail(ByVal session As UserSession, ByVal userCode As String, ByVal idSucursal As Integer) As IncidenciaInfo
    ...
    ''' <returns>Paquete de información IncidenciaInfo</returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function GetDetail(ByVal session As UserSession, ByVal userCode As String, ByVal idSucursal As Integer, ByVal checkStatus As Boolean) As IncidenciaInfo
        Dim IncidenciaInf As New IncidenciaInfo(session)
        Dim IncidenciaSvc As New IncidenciaService(session)
    ...
    ''' <remarks></remarks>
    Public Overrides Function Update(ByVal Incidencia As IncidenciaInfo) As Integer
    	Dim IncidenciaSvc As New IncidenciaService(Incidencia.session)
