Partial Class GrupoClasificacionesService
    ...
    Public Function CargarEntidades() As DataTable
        Try
            Dim fxEntidades As New FunctionSQL("Inventory", "fxClasificacionesEntidadesCBO", Connection, Transaction)
    ...
    Public Function CargarClasificaciones(ByVal idEntidad As Integer) As DataTable
        Try
            Dim fxList As New FunctionSQL("Inventory", "fxClasificacionesCBO", Connection, Transaction)
