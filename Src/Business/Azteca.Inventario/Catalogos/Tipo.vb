Partial Public Class TipoService

    Public Function LoadList(idEmpresa As Integer) As DataTable
        Try
            Dim fxList As New FunctionSQL("Inventory", "fxTiposCBO", Connection, Transaction)
...
Partial Public Class TipoFacade
    ...
    Public Function LoadList(sessionID As Guid, idEmpresa As Integer) As DataTable
        ...
        Try
            ...
            Dim Svc As New TipoService(sessionID, Connection, Transaction)
