...
#Region "Propiedades"
    ...
    Public Property IdChequeraPredeterminada As Integer
...
#Region "Constructores"
    ...
    Public Sub New(ByVal sessionID As GUID, ByVal cnn As IDbConnection, ByVal tran As IDbTransaction)
        MyBase.New("Treasury","Cajas", sessionID)
        Me.Connection = cnn
        Me.Transaction = tran
    End Sub
#End Region
...
#Region "Metodos de CatalogService"
    Public Overrides Sub GetDetail(ByVal idCaja As Integer, ByRef Caja As CajaInfo, checkStatus As Boolean)
		MyBase.GetDetail(idCaja, Caja, checkStatus)
        With Caja
			.Nombre = CStr(ItemInfo("Nombre"))
			.IdCuenta = CInt(ItemInfo("IdCuenta"))
            .IdChequeraPredeterminada = CInt(ItemInfo("IdChequeraPredeterminada"))
		End With
	End Sub
	...
	Public Overrides Function Update(ByVal Caja As CajaInfo) As Integer
        With Me.SPUpdate.Parameters
            ...
            .Add("@IdChequeraPredeterminada", DbType.Int32).Value = Caja.IdChequeraPredeterminada
		End With
...
#Region "Metodos de CatalogFacade"
    ...
    ''' <returns>Paquete de información de tipo CajaInfo</returns>
    ''' <remarks></remarks>
    Public Overrides Function GetDetail(ByVal sessionID As GUID, ByVal idCaja As Integer, checkStatus As Boolean) As CajaInfo
   		Dim CajaSvc As New CajaService(sessionID)
