...
#Region "Constructores"
    ...
    Public Sub New(ByVal sessionID As GUID, ByVal cnn As IDbConnection, ByVal tran As IDbTransaction)
        MyBase.New("Sales", "ClasificacionesGrupos", sessionID)
        Me.Connection = cnn
        Me.Transaction = tran
    End Sub
#End Region
...
#Region "Metodos Privados"
    ...
    Private Sub CargarClasificaciones(ByVal idGrupo As Integer, ByVal grupo As GrupoClasificacionesInfo)
        Try
            Dim fxClasificaciones As New FunctionSQL("Sales", "fxClasificacionesSEL", Connection, Transaction)
    ...
    Private Sub GuardarClasificaciones(ByVal idGrupo As Integer, ByVal grupo As GrupoClasificacionesInfo)
        Try
            Dim comUpdate As New DbCommand("Sales.ClasificacionesUPD", Connection, Transaction)
            ...
            '
            Dim comDelete As New DbCommand("Sales.ClasificacionesDEL", Connection, Transaction)
