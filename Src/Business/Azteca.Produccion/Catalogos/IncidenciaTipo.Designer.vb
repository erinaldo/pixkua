...
#Region "Propiedades"
    ...
    Public Property NoContabilizar As Boolean
...
#Region "Metodos de CatalogService"
    Public Overrides Sub GetDetail(ByVal idIncidenciaTipo As Integer, ByRef IncidenciaTipo As IncidenciaTipoInfo, checkStatus As Boolean)
        ...
        With IncidenciaTipo
            ...
            .NoContabilizar = CBool(Me.ItemInfo("NoContabilizar"))
		End With
	End Sub
	...
	Public Overrides Function Update(ByVal IncidenciaTipo As IncidenciaTipoInfo) As Integer
        With Me.SPUpdate.Parameters
            ...
            .Add("@NoContabilizar", DbType.Boolean).Value = IncidenciaTipo.NoContabilizar
		End With
		Return MyBase.Update(IncidenciaTipo)
	End Function
	
	Public Overrides Function Create() As IncidenciaTipoInfo
        Return New IncidenciaTipoInfo(SessionID)
	End Function
...
#Region "Metodos de CatalogFacade"
    ...
    ''' <remarks></remarks>
    Public Overrides Function Create(ByVal session As Guid) As IncidenciaTipoInfo
    ...
    ''' <remarks></remarks>
    Public Overrides Sub Delete(ByVal session As Guid, ByVal idIncidenciaTipo As Integer)
        Dim IncidenciaTipoSvc As New IncidenciaTipoService(session)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overrides Function Exists(ByVal session As Guid, ByVal idIncidenciaTipo As Integer) As Boolean
        Dim IncidenciaTipoSvc As New IncidenciaTipoService(session)
    ...
    ''' <remarks></remarks>
    Public Overrides Function GetDetail(ByVal session As Guid, ByVal idIncidenciaTipo As Integer) As IncidenciaTipoInfo
    ...
    ''' <returns>Paquete de información de tipo IncidenciaTipoInfo</returns>
    ''' <remarks></remarks>
    Public Overrides Function GetDetail(ByVal session As Guid, ByVal idIncidenciaTipo As Integer, checkStatus As Boolean) As IncidenciaTipoInfo
        Dim IncidenciaTipoSvc As New IncidenciaTipoService(session)
    ...
    ''' <remarks></remarks>
    Public Overloads Overrides Function GetDetail(ByVal session As Guid, ByVal userCode As String, ByVal idSucursal As Integer) As IncidenciaTipoInfo
    ...
    ''' <returns>Paquete de información IncidenciaTipoInfo</returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function GetDetail(ByVal session As Guid, ByVal userCode As String, ByVal idSucursal As Integer, ByVal checkStatus As Boolean) As IncidenciaTipoInfo
        Dim IncidenciaTipoInf As New IncidenciaTipoInfo(session)
        Dim IncidenciaTipoSvc As New IncidenciaTipoService(session)
    ...
    ''' <remarks></remarks>
    Public Overrides Function Update(ByVal IncidenciaTipo As IncidenciaTipoInfo) As Integer
        Dim IncidenciaTipoSvc As New IncidenciaTipoService(IncidenciaTipo.SessionID)
