CREATE PROCEDURE [Sales].[PedidosArticulosUPD]	
...
AS
	...
	IF EXISTS (SELECT IdPedidoTit FROM Sales.PedidosDet WHERE IdPedidoTit=@IdPedidoTit and Fecha=@Fecha AND IdArticuloStock=@IdArticuloStock AND IdServicio=@IdServicio)
