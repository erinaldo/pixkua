CREATE FUNCTION [Sales].[fxPedidosArticulosSEL](@IdPedidoTit as char(18), @IdUsuario as int)
RETURNS TABLE
AS
RETURN	(
	SELECT D.IdArticuloStock, D.Codigo, D.Descripcion, D.Cantidad, D.IdUnidadMedida, UM.IdUnidadMedidaTipo,
		D.PrecioUnitario, D.IdPromocion, D.PorcComision, D.MontoComision, 
	...
	FROM Sales.PedidosDet D JOIN Inventory.ArticulosStock AX
