...
Public Class RecetaPrint
    Inherits System.Web.UI.Page
    Private IdExpediente As Integer
    ...
    Private Function GenerarPDF() As Byte()
        ...
        Try
            ...
            Dim fxExpediente As New FunctionSQL("Medicine", "fxRecetaRPT", Connection, Nothing)
            fxExpediente.Parameters.Add("@IdExpediente", DbType.Int32).Value = IdExpediente
            fxExpediente.Parameters.Add("@Fecha", DbType.Date).Value = Fecha
            ...
            Dim reader As TextReader = File.OpenText(Server.MapPath("Receta.rdlc"))
        ...
        Catch ex As Exception
            Throw New Exception("Error al descargar la receta.", ex)
        End Try
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        IdExpediente = CInt(Request.QueryString("IdExpediente"))
        ...
        If Not Page.IsPostBack Then
            ...
            Response.AddHeader("content-disposition", "inline; filename=Expediente_" & IdExpediente & ".pdf")
