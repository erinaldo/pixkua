    ...
    element.catalogselector({
        ...
        displayMember: function (item) {
            if (item.Estado != undefined)
                return item.Poblacion + ', ' + item.Estado;
            else
                return item.Poblacion + ', ' + item.Municipio.Estado.Nombre;
        }
    });
}

Kernel.Controls.UsuariosSelector = function (element) {
    var ListColumns = [
                        { headerText: "ID", visible: false, dataKey: "ID" },
                        { headerText: "IdUsuario", visible: false, dataKey: "IdUsuario" },
                        { headerText: "Usuario", width: 80, dataKey: "Usuario", dataType: "string", filterOperator: "BeginsWith" },
                        { headerText: "Apellidos", width: 80, dataKey: "Apellidos", dataType: "string", filterOperator: "BeginsWith" },
                        { headerText: "Nombre", width: 200, dataKey: "Nombre", dataType: "string", filterOperator: "BeginsWith" },
                        { headerText: "Correo", width: 90, dataKey: "Correo", dataType: "string", filterOperator: "BeginsWith" }
                    ];

    element.catalogselector({
        listColumns: ListColumns,
        catalogService: new Kernel.Security.UsuarioService(),
        dialogTitle: "Catálogo de Usuarios",
        width: 350,
        displayMember: function (item) {
...
Kernel.Forms.CatalogForm = function (options) {
    ...
    if (this.DialogOnly == false) {
        ...
        this.CatalogList.wijgrid({
            ...
            pageIndexChanging: function (e, args) {
                ...
                thisForm.Service.Search(1, Conditions, SortOrder, args.newPageIndex + 1);
            },
            ...
            filtered: function (e, args) {
                ...
                thisForm.Service.Search(1, Conditions, SortOrder, 1);
                thisForm.CatalogList.wijgrid('ensureControl', true);
            },
            loaded: function () {
        ...
        this.Service.Search(1, null, null, 1);
    ...
    this.RefreshList = function () {
        ...
        this.Service.Search(1, Conditions, SortOrder, CurrentPage + 1);
