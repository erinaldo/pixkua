...
(function ($) {
    $.widget("ui.catalogselector", {
        ...
        _create: function () {
            ...
            this.options._$Input.autocomplete({
                ...
                source: function (request, response) {
                    thisWidget.options.catalogService.SearchKeyword(request.term)
                        .done(function (data) {
                ...
                change: function (e, ui) {
                    if (ui.item == null) {
                        ...
                        thisWidget.options.text=ui.item.label;
            ...
            thisWidget.options._$Dialog.wijdialog({
                autoOpen: false,
                modal: true,
                            ...
                            args.$container.empty().append(
                                $("<a href='#'><img src='" + App.ImagePath + "/General/OK_16.png' alt='' class=''/></a>")
                                    .click(function (e) {
                                        ...
                                        thisWidget.options._$Dialog.wijdialog('close');
            ...
            this.options._$Grid.wijgrid({
                ...
                pageIndexChanging: function (e, args) {
                    ...
                    thisWidget.options.catalogService.Search(1, Conditions, SortOrder, args.newPageIndex + 1)
                        .done(function (data) {
                            var result = $.parseJSON(data);
                ...
                filtered: function (e, args) {
                    ...
                    thisWidget.options.catalogService.Search(1, Conditions, SortOrder, 1)
                        .done(function (data) {
                            var result = $.parseJSON(data);
                            thisWidget.options._$Grid.wijgrid({ data: result.Rows, totalRows: result.TotalRows });
                        })
            ...
            $Button.bind("click", function (e) {
                thisWidget.options._$Grid.wijgrid({ pageIndex: 0 });
                thisWidget.options.catalogService.Search(1, null, null, 1)
                    .done(function (data) {
                        var result = $.parseJSON(data);
                        thisWidget.options._$Grid.wijgrid({ data: result.Rows, totalRows: result.TotalRows });
                    })
                ...
                thisWidget.options._$Dialog.wijdialog('open');
                return false;
            });
        ...
        _refreshList: function () {
            ...
            this.options.catalogService.Search(1, Conditions, SortOrder, CurrentPage + 1)
                .done(function (data) {
                    var result = $.parseJSON(data);
                    thisWidget.options._$Grid.wijgrid({ data: result.Rows, totalRows: result.TotalRows });
                })
