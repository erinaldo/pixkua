Namespace Services.Kernel
    ...
    Public Interface ICatalogWebService
        ...
        <OperationContract()>
        <WebInvoke(ResponseFormat:=WebMessageFormat.Json, BodyStyle:=WebMessageBodyStyle.WrappedRequest)>
        Function GetDetailByID(sessionID As Guid, itemID As Integer, checkStatus As Boolean) As String

        <OperationContract()>
        <WebInvoke(ResponseFormat:=WebMessageFormat.Json, BodyStyle:=WebMessageBodyStyle.WrappedRequest)>
        Function GetDetailByCode(sessionID As Guid, idBranch As Integer, code As String, checkStatus As Boolean) As String
        ...
        <OperationContract()>
        <WebInvoke(ResponseFormat:=WebMessageFormat.Json, BodyStyle:=WebMessageBodyStyle.WrappedRequest)>
        Function LoadList(sessionID As Guid, idBranch As Integer) As String
