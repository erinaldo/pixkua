...
#Region "Metodos Privados"
    ...
    Private Sub ClearMenu()
        tlbComercial.CommandLinks.Clear()
        tlbFinanzas.CommandLinks.Clear()
        tlbLogistica.CommandLinks.Clear()
        tlbManufactura.CommandLinks.Clear()
        tlbRH.CommandLinks.Clear()
