...
Public NotInheritable Class Context
    ...
    Public Shared Sub Initialize()
        ...
        If UnidadFac.Exists(App.Session.SessionID, App.DefaultSite.Identity) Then _UnidadNegocio = UnidadFac.GetDetailByIdSucursal(App.Session.SessionID, App.DefaultSite.Identity)
        _Servicios.Clear()
        _Articulos.Clear()
