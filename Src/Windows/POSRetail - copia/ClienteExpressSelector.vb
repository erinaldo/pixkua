Public Class ClienteExpressSelector
    ...
    Public Sub New()
        ...
        If Not Me.DesignMode Then
            ...
            Me.EditorAssembly = "Azteca.Windows.Ventas"
            Me.EditorClass = "ClienteExpressForm"
    ...
    Protected Overrides Sub OnEditingItem(e As System.EventArgs)
        MyBase.OnEditingItem(e)
    End Sub
